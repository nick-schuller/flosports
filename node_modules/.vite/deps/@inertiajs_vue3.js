...
function toFormData(obj, formData, options) {
  ...
  function build(value, path) {
    ...
    utils_default.forEach(value, function each(el, key2) {
      const result2 = !(utils_default.isUndefined(el) || el === null) && visitor.call(formData, el, utils_default.isString(key2) ? key2.trim() : key2, path, exposedHelpers);
      if (result2 === true) {
...
var Axios = class {
  ...
  _request(configOrUrl, config3) {
    ...
    headers && utils_default.forEach(["delete", "get", "head", "post", "put", "patch", "common"], (method2) => {
